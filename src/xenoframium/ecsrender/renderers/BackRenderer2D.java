 ...
 */
class BackRenderer2D {
    private static EntityFilter filter = new BasicFilter(BackRenderComponent2D.class);

    public Projection projection;

    public BackRenderer2D(Projection projection) {
        this.projection = projection;
    }

    private void renderEntity(Entity entity, Mat4 vp) {
        BackRenderComponent2D renderComponent2D = entity.getComponent(BackRenderComponent2D.class);
